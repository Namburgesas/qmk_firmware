...
[_QWERTY] = LAYOUT( \
  ...
  SC_LSPO,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_F2,   SC_SENT, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SC_RSPC,  \
                             KC_LALT, KC_LGUI, LWR_ESC, SC_SENT, KC_SPC,  RSE_TAB, KC_DOWN, KC_UP \
),

[_LOWER] = LAYOUT( \
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_NUM, KC_PSLS, KC_PAST, KC_PMNS,  _______, \
  KC_GRV , KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_P7,  KC_P8,   KC_P9,   KC_PPLS,  MSWHLT,  \
  _______, KC_LSFT, _______, KC_EQL,  KC_MINS, KC_LPRN,                   KC_RPRN, KC_P4,  KC_P5,   KC_P6,   KC_PPLS,  MSWHRT,  \
  _______, _______, _______, KC_DQUO, KC_QUOT, KC_LBRC, _______, _______, KC_RBRC, KC_P1,  KC_P2,   KC_P3,   KC_PENT,  _______, \
                             _______, _______, _______, _______, _______, KC_P0,   KC_P0,  KC_PDOT \
),

[_RAISE] = LAYOUT( \
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, \
  _______, KC_HOME, KC_UP,   KC_PGUP, KC_GRV,  KC_INS,                    KC_PSCR, KC_LPRN, KC_RPRN, KC_F11,  KC_F12,  _______, \
  KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC, KC_DEL,                    _______, KC_MINS, KC_EQL,  KC_PAUS, KC_SCRL, _______, \
  _______, KC_END,  KC_APP,  KC_PGDN, KC_BSLS, KC_CAPS, _______, _______, _______, KC_QUOT, KC_DQUO, KC_VOLD, KC_VOLU, _______, \
                             _______, _______, _______, _______, KC_LSFT, _______, KC_MINS, KC_EQL \
),
